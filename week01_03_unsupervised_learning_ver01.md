...
+ 알고리즘에게 레이블이 없는 방대한 데이터를 주고 데이터에 내재되어 있는 구조를 발견하라고 묻는 학습 환경
...
#### __clustering algorithm을 적용한 예시는? (2/2) ####
...
따라서 cocktail party algorithm이란 다음과 같습니다.

+ 소리#1과 소리#2를 동시에 틀고 각각 다른 거리에 있는 녹음기#1과 녹음기#2로 녹음한 2가지 녹음파일을 활용해서 2가지 소리를 분리하는 알고리즘
...
**Q2. unsupervised learning이란?**  
A2. 알고리즘에게 레이블이 없는 방대한 데이터를 주고 데이터에 내재되어 있는 구조를 발견하라고 묻는 학습 환경

**Q3. unsupervised learning에 속하는 알고리즘 2개는?**  
A3. clustering algorithm, cocktail party algorithm

**Q4. clustering algorithm이란?**  
A4. 데이터를 가까이 모여 있는 집단별로 구분하는 알고리즘 

**Q5. clustering algorithm의 예시는?**  
A5. Google News, Genomics, 컴퓨터 클러스터, 소셜 네트워크 분석, 시장 세분화, 천문 데이터 분석

**Q6. coctail party algorithm이란?**  
A6. 소리#1과 소리#2를 동시에 틀고 각각 다른 거리에 있는 녹음기#1과 녹음기#2로 녹음한 2가지 녹음파일을 활용해서 2가지 소리를 분리하는 알고리즘

**Q7. 다음 문제를 푸시오.**
![wrap up question](https://github.com/datalater/ML_AndrewNg_study/blob/master/images/UnsupervisedLearnig_wrapup_question.png?raw=true)  
A7. 비공, 비공개

**Q8. cocktail party algorithm은 clustering algorithm과 다른가?**  
A8. 다르다. cocktail party algorithm은 non-clustering algorithm이다.
